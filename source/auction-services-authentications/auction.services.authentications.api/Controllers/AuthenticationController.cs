using auction.services.authentications.api.Controllers.Abstracts;
...
using LoginRequest = auction.services.authentications.domain.DTOs.Requests.LoginRequest;

namespace auction.services.authentications.api.Controllers;
